...
import frc.robot.ConstantsElevator;
...
public class Elevator extends SubsystemBase {
  ...
  private Elevator() {
    //Motor
    elevatorMotor = new CANSparkMax(ConstantsElevator.ELEVATOR_MOTOR, com.revrobotics.CANSparkMaxLowLevel.MotorType.kBrushless);
  ...
  public double getElevatorPIDOutput(double setpoint) {
    return elevatorPID.calculate(encoderElevator.getDistance(), setpoint);
  }
